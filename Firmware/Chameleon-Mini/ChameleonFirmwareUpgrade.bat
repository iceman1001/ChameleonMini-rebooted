...
"%~dp0dfu-programmer.exe" atxmega32a4u erase
...
"%~dp0dfu-programmer.exe" atxmega32a4u flash-eeprom "%~dp0Chameleon-Mini.eep" --force
...
"%~dp0dfu-programmer.exe" atxmega32a4u flash "%~dp0Chameleon-Mini.hex"
...
"%~dp0dfu-programmer.exe" atxmega32a4u launch
